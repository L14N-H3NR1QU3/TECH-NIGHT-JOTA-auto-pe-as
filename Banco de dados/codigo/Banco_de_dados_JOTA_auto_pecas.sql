...
CREATE TABLE `carro` (
  ...
  `Placa_carro` int(11) DEFAULT NULL,
...
CREATE TABLE `cliente` (
  ...
  `sobreNome_cliente` varchar(50) DEFAULT NULL,
  `ID_carro_Clienet` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_cliente`),
  KEY `ID_carro_Clienet` (`ID_carro_Clienet`),
  CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`ID_carro_Clienet`) REFERENCES `carro` (`id_carro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-11-05 21:40:38
